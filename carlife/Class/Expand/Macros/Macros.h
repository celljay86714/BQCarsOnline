...
#define DEFAULT_COLOR RGB(0,122,255)
...
#define CFWeakSelf(type)  __weak typeof(type) weak##type = type;
#define CFStrongSelf(type)  __strong typeof(type) type = weak##type;
...
//偏好设置
#define SKUserDefaults [GVUserDefaults standardUserDefaults]
