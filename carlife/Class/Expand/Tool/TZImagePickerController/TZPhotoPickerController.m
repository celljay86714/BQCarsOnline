...
- (void)configBottomToolBar {
   ...
   // _previewButton.tz_width = tzImagePickerVc.maxImagesCount <= 1 ? 0 : previewWidth + 2;
    ...
    [_previewButton setTitleColor:VKDefaultYellow forState:UIControlStateNormal];
    ...
    CGRect labelFrame = CGRectMake(self.view.tz_width - 56 - labelWidth, 10, labelWidth, 30);
    /*
    ...
    _numberLable.text = [NSString stringWithFormat:@"(%zd/%zd)",tzImagePickerVc.selectedModels.count, tzImagePickerVc.maxImagesCount];
    ...
    if (tzImagePickerVc.selectedModels.count) {
        ...
        for (NSInteger i = 0; i < tzImagePickerVc.selectedModels.count; i++) {
            ...
            [[TZImageManager manager] getPhotoWithAsset:model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
                ...
                [self imagePickerControllerSelectComplete:tzImagePickerVc didFinishPickingPhotos:photos sourceAssets:assets infos:infoArr];
...
- (void)imagePickerControllerSelectComplete:(TZImagePickerController *)tzImagePickerVc didFinishPickingPhotos:(NSArray<UIImage *> *)photos sourceAssets:(NSArray *)assets infos:(NSArray<NSDictionary *> *)infoArr {
...
- (void)refreshBottomToolBarStatus {
    ...
    _numberLable.text = [NSString stringWithFormat:@"(%zd/%zd)",imagePickerVc.selectedModels.count, imagePickerVc.maxImagesCount];
